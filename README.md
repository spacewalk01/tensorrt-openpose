...
```
- Install [CUDA](https://developer.nvidia.com/cuda-11.1.0-download-archive) and CUDNN(https://developer.nvidia.com/cudnn). For cudnn installation, refer to the nvidia [cudnn installation guide](https://docs.nvidia.com/deeplearning/cudnn/install-guide/index.html)
